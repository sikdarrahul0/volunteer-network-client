...
const AddEvent = () => {
    ...
    return (
        <section className="addevent-section">
                <div className="row">
                        ...
                        <div className="addevent-box-in">
                            <div style={{display: 'flex'}}>
                                <div style={{marginRight: '150px'}}>
                                    ...
                                    <input type="text" onChange={handleOnChange} name="name" placeholder="Enter title"/>
                                </div>
                                <div>
                                    <label htmlFor=""><strong>Event Date</strong></label><br/>
                                    <input type="date" onChange={handleOnChange} name="date"/>
                                </div>
